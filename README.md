...
- Modify `.stylelintrc.json` by replacing the prefix `example` with the prefix you have chosen, in the following rules:
  - `custom-property-pattern`
  - `selector-class-pattern`
  - `keyframes-name-pattern`
- Choose and register an npm organisation on [npmjs.com](https://www.npmjs.com/org/create), if you haven't already. This is very important to keep your project secure. The core NL Design System uses `@nl-design-system/`, and you can choose something for yourself. This prevents others from adding their code to your teams codebase.
- Modify the `package.json` and `package-lock.json` files to use your npm organisation scope.
